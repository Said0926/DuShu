...
def _as_spoken(sentence: Sentence, audio: SentenceAudio) -> SpokenSentence:
    """Pair one processed sentence with its cached audio."""
...
def speak_text(processed: ProcessedText) -> list[SpokenSentence]:
    ...
    return [_as_spoken(sentence, audio[sentence.text]) for sentence in processed.sentences]
